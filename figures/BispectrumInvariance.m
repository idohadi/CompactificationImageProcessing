...
fnNOEXT = ['BispectrumInvariance-', dt]; 
...
% Choose the lowest scaling paramter yielding mean relative error of less 
% than 0.05 for bandlimit 16
% TODO: fix docs to how I chose it from the graph
scalingParam = 1;
...
maxTranslationSize = 15;
translationSizeGrid = 0:0.2:maxTranslationSize;
sampleNo = 2*10^3; % Number of samples from [0, 2*pi]^2
