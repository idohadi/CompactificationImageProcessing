...
fnNOEXT = ['ClassificationCryoLargeScale-', dt]; 
...
ea = 0.6;
hold;
histogram(results.classSpecificityRotOnly, bins, ...
    'FaceAlpha', fa, 'EdgeAlpha', ea);
histogram(results.classSpecificityRotAndTrans, bins, ...
    'FaceAlpha', fa, 'EdgeAlpha', ea);
set(gca, 'yscale', 'log');

title('Distribution of Node Score');
xlabel('Node score');
